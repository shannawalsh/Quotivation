        ...
        <section className="favorite-quotes">
          <div className="wrapper quotes">
            <div className="favorite-quotes-description">
              <p>You can add {remainingFavoriteAmount} {remainingFavoriteAmount < 3 && "more"} {remainingFavoriteAmount === 1 ? "quote" : "quotes"} to your top three favorites by selecting from the options below. 
              <br/>
              Once you choose your favories, they will appear here:</p>
            </div>
            {remainingFavoriteAmount < 3 && <h3>Top 3 favorite quotes</h3>}
